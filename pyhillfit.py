...
# TODO - Figure out transformations/shifts, so we don't store everything.
# https://docs.pymc.io/notebooks/api_quickstart.html#Transformed-distributions-and-changes-of-variables
#      - Test different samplers, ICs, etc.
